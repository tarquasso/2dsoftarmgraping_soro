...
\rkk{Ikuta and Suzuki \cite{ikuta2002safety} showed a multiple-segment micro-hydraulic actuator for entering blood vessels.}
...
%talk about control
\rkk{Simulation results of an online motion planner for a planar continuum manipulators were presented by Xiao and Vatcha\cite{xiao2010realtime}.}
...
Marchese et al. \cite{marchese2014design}  \cite{marchese2014whole} demonstrated closed-loop position control of multi-segment soft planar fluidic elastomer manipulators in free and confined space. 
...
The previous version \rkk{was only suitable for inspection tasks by moving the manipulator through a constrained environment without object interaction or manipulation.}
...
\rkk{The work presented here builds on the previous system. We now combine two soft actuator types to leverage their strengths in a manipulation task. A new control method demonstrates the capabilities of this new soft manipulator to actually do autonomous manipulations under uncertainties.}
...
\begin{itemize}  \item A planning algorithm to grasp-and-place randomly positioned objects on a planar surface using a 7 DOF soft manipulator.  
  \item \rkk{Proper autonomous manipulation of various objects} \dr{of unknown geometry placed randomly in the working space of a soft manipulator} \rkk{without requiring force sensing or accurate positioning.} 
