...
\begin{itemize}
  ...
  \item \rkk{Demonstrating that soft robots allow for proper autonomous manipulation of delicate objects without requiring force sensing or accurate positioning.} 
\end{itemize}
