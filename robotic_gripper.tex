...
\begin{figure}[thpb]
\centering
   \includegraphics[width=0.99\columnwidth]{figures/robotic_gripper/design_gripper.eps}
...
The gripper fabrication process and the tools needed are fully described and depicted in Section~4.3. and Figure~14 of the recipes paper for soft fluidic elastomer actuators \cite{marchese2015recipe}. %Figure~\ref{fig:fabrication}.
